...
function commandUI(p) {
    ...
    if (p === player[0]){
        ctx.drawImage(recolourUiGfx(gfxUI[UI_GFX_ICON_BACK],COLOUR[COLOUR_BLUE]), (p.ScreenX + 72) * scale, (p.ScreenY + 16) * scale, gfxUI[UI_GFX_ICON_BACK].width * scale, gfxUI[UI_GFX_ICON_BACK].height * scale);
    }else{
        ctx.drawImage(recolourUiGfx(gfxUI[UI_GFX_ICON_BACK],COLOUR[COLOUR_RED]), (p.ScreenX + 72) * scale, (p.ScreenY + 16) * scale, gfxUI[UI_GFX_ICON_BACK].width * scale, gfxUI[UI_GFX_ICON_BACK].height * scale);
    }
...
function drawPocketUI(p) {
    ...
    for (y = 0; y < 2; y++) {
        for (x = 0; x < 6; x++) {
            ...
            if (pocketId >= 88 && pocketId <= 92){
                if (p === player[0]){
                    ctx.drawImage(recolourUiGfx(gfxUI[pocketId],COLOUR[COLOUR_BLUE]), ((p.ScreenX + 225) + (x * 16)) * scale, ((p.ScreenY + 23) + (y * 16)) * scale, gfxUI[pocketId].width * scale, gfxUI[pocketId].height * scale);
                }
                else{
                    ctx.drawImage(recolourUiGfx(gfxUI[pocketId],COLOUR[COLOUR_RED]), ((p.ScreenX + 225) + (x * 16)) * scale, ((p.ScreenY + 23) + (y * 16)) * scale, gfxUI[pocketId].width * scale, gfxUI[pocketId].height * scale);
                }
            }else{
    ...
    for (x = 0; x < 6; x++) {
        ...
        switch (x) {
            ...
            case 5:
                {
                    if (p === player[0]){
                        ctx.drawImage(recolourUiGfx(gfxUI[UI_GFX_ICON_BACK],COLOUR[COLOUR_BLUE]), ((p.ScreenX + 225) + (x * 16)) * scale, ((p.ScreenY + 63)) * scale, gfxUI[UI_GFX_POCKET_EMPTY].width * scale, gfxUI[UI_GFX_POCKET_EMPTY].height * scale);
                    }
                    else{
                        ctx.drawImage(recolourUiGfx(gfxUI[UI_GFX_ICON_BACK],COLOUR[COLOUR_RED]), ((p.ScreenX + 225) + (x * 16)) * scale, ((p.ScreenY + 63)) * scale, gfxUI[UI_GFX_POCKET_EMPTY].width * scale, gfxUI[UI_GFX_POCKET_EMPTY].height * scale);
                    }
...
function itemID(id) {
    ...
    switch (id) {
        ...
        case 1:
            {
                return UI_GFX_POCKET_COIN;
            } //Coinage
        case 2:
            {
                return UI_GFX_POCKET_COMMON_KEY;
            } //Common Keys
        case 3:
            {
                return UI_GFX_POCKET_ARROW;
            } //Arrows
        case 4:
            {
                return UI_GFX_POCKET_ELF_ARROW;
            } //Elf Arrows
        case 5:
            {
                return UI_GFX_POCKET_APPLE_1;
            } //1/3 Apple
        case 6:
            {
                return UI_GFX_POCKET_APPLE_2;
            } //2/3 Apple
        case 7:
            {
                return UI_GFX_POCKET_APPLE_3;
            } //Apple
        case 8:
            {
                return UI_GFX_POCKET_BISCUIT_1;
            } //1/3 Biscuit
        case 9:
            {
                return UI_GFX_POCKET_BISCUIT_2;
            } //2/3 Biscuit
        case 10:
            {
                return UI_GFX_POCKET_BISCUIT_3;
            } //Biscuit
        case 11:
            {
                return UI_GFX_POCKET_CHICKEN_1;
            } //1/3 Chicken
        case 12:
            {
                return UI_GFX_POCKET_CHICKEN_2;
            } //2/3 Chicken
        case 13:
            {
                return UI_GFX_POCKET_CHICKEN_3;
            } //Chicken
        case 14:
            {
                return UI_GFX_POCKET_WATER_1;
            } //1/3 Mead
        case 15:
            {
                return UI_GFX_POCKET_WATER_2;
            } //2/3 Mead
        case 16:
            {
                return UI_GFX_POCKET_WATER_3;
            } //Mead
        case 17:
            {
                return UI_GFX_POCKET_WATER_1;
        ...
        case 27:
            {
                return UI_GFX_POCKET_AMOUR_LEATHER;
            } //Leather Armour
        case 28:
            {
                return UI_GFX_POCKET_AMOUR_CHAIN;
            } //Chain Mail
        case 29:
            {
                return UI_GFX_POCKET_AMOUR_PLATE;
            } //Plate Mail
        case 30:
            {
                return UI_GFX_POCKET_AMOUR_CHAIN;
        ...
        case 36:
            {
                return UI_GFX_POCKET_SHIELD_1;
            } //Leather Shield
        case 37:
            {
                return UI_GFX_POCKET_SHIELD_2;
            } //Buckler
        case 38:
            {
                return UI_GFX_POCKET_SHIELD_3;
            } //Rune Shield (Classic)
        case 39:
            {
                return UI_GFX_POCKET_SHIELD_4;
            } //Large Shield
        case 40:
            {
                return UI_GFX_POCKET_SHIELD_5;
            } //Moon Shield
        case 41:
            {
                return UI_GFX_POCKET_SHIELD_6;
            } //Dragon Scale
        case 42:
            {
                return UI_GFX_POCKET_SHIELD_7;
            } //War Shield
        case 43:
            {
                return UI_GFX_POCKET_GLOVE;
            } //Chaos Gloves
        case 44:
            {
                return UI_GFX_POCKET_GLOVE;
        ...
        case 48:
            {
                return UI_GFX_POCKET_DAGGER;
            } //Dagger
        case 49:
            {
                return UI_GFX_POCKET_SWORD_1;
            } //Stealth Blade
        case 50:
            {
                return UI_GFX_POCKET_SHORT_SWORD;
            } //Short Sword
        case 51:
            {
        ...
        case 52:
            {
                return UI_GFX_POCKET_SWORD_4;
            } //Mithril Sword
        case 53:
            {
                return UI_GFX_POCKET_SWORD_5;
            } //Fleshbane
        case 54:
            {
                return UI_GFX_ICON_UNKNOWN;
            } //Demon Blade
        case 55:
            {
                return UI_GFX_ICON_UNKNOWN;
        ...
        case 56:
            {
                return UI_GFX_POCKET_AXE_1;
            } //Battle Axe
        case 57:
            {
                return UI_GFX_POCKET_AXE_2;
            } //Mithril Axe
        case 58:
            {
                return UI_GFX_POCKET_AXE_3;
            } //Troll's Axe
        case 59:
            {
                return UI_GFX_POCKET_AXE_4;
            } //Brainbiter
        case 60:
            {
                return UI_GFX_POCKET_AXE_1;
...
function createShield(id, type, colour) {
    ...
    if (colour === PALETTE_DEAD){
        context.drawImage(recolourUiGfx(gfxUI[UI_GFX_SHIELD_TOP], COLOUR[COLOUR_BLACK]), 0, 0);
        context.drawImage(recolourUiGfx(gfxUI[UI_GFX_SHIELD_CHARACTERS][id], COLOUR[COLOUR_BLACK]), 0, 5);
        context.drawImage(recolourSprite(gfxUI[UI_GFX_SHIELD_TYPES][type], SHIELD_PALETTE_DEFAULT, colour), 1, 21);
        context.drawImage(recolourUiGfx(gfxUI[UI_GFX_SHIELD_BOTTOM], COLOUR[COLOUR_BLACK]), 5, 32);
    }else{
        context.drawImage(recolourUiGfx(gfxUI[UI_GFX_SHIELD_TOP], COLOUR[COLOUR_GREY_LIGHT]), 0, 0);
        context.drawImage(recolourUiGfx(gfxUI[UI_GFX_SHIELD_CHARACTERS][id], COLOUR[COLOUR_GREY_LIGHT]), 0, 5);
        context.drawImage(recolourSprite(gfxUI[UI_GFX_SHIELD_TYPES][type], SHIELD_PALETTE_DEFAULT, colour), 1, 21);
        context.drawImage(recolourUiGfx(gfxUI[UI_GFX_SHIELD_BOTTOM], COLOUR[COLOUR_GREY_LIGHT]), 5, 32);
    }
...
function recolourUiGfx(img,colourTo){
