...
function initItemRefs() {
    ...
    if (gameType === GAME_EXTENDED_LEVELS){
        createItemRef(36, "Rune Shield (Red)", gfxUI[UI_GFX_POCKET_RUNE_SHIELD], recolourSpriteArray(itemsGfxD[DUNGEON_ITEM_SMALL_SHIELD], DUN_ITEM_PALETTE_DEFAULT, new Array(COLOUR[COLOUR_PINK], COLOUR[COLOUR_BROWN], COLOUR[COLOUR_RED_DARK], COLOUR[COLOUR_BROWN])));
        createItemRef(37, "Rune Shield (Green)", gfxUI[UI_GFX_POCKET_RUNE_SHIELD], recolourSpriteArray(itemsGfxD[DUNGEON_ITEM_SMALL_SHIELD], DUN_ITEM_PALETTE_DEFAULT, new Array(COLOUR[COLOUR_WHITE], COLOUR[COLOUR_GREY_LIGHT], COLOUR[COLOUR_GREY_MEDIUM], COLOUR[COLOUR_GREY_MEDIUM])));
        createItemRef(38, "Rune Shield (Black)", gfxUI[UI_GFX_POCKET_RUNE_SHIELD], recolourSpriteArray(itemsGfxD[DUNGEON_ITEM_SMALL_SHIELD], DUN_ITEM_PALETTE_DEFAULT, new Array(COLOUR[COLOUR_WHITE], COLOUR[COLOUR_GREY_LIGHT], COLOUR[COLOUR_GREY_MEDIUM], COLOUR[COLOUR_RED])));
        createItemRef(39, "War Shield", gfxUI[UI_GFX_POCKET_WAR_SHIELD], recolourSpriteArray(itemsGfxD[DUNGEON_ITEM_LARGE_SHIELD], DUN_ITEM_PALETTE_DEFAULT, new Array(COLOUR[COLOUR_WHITE], COLOUR[COLOUR_GREY_LIGHT], COLOUR[COLOUR_GREY_MEDIUM], COLOUR[COLOUR_BLACK])));
        createItemRef(40, "Demon Scale", gfxUI[UI_GFX_POCKET_DEMON_SCALE], recolourSpriteArray(itemsGfxD[DUNGEON_ITEM_LARGE_SHIELD], DUN_ITEM_PALETTE_DEFAULT, new Array(COLOUR[COLOUR_WHITE], COLOUR[COLOUR_BLUE], COLOUR[COLOUR_BLUE_DARK], COLOUR[COLOUR_BLACK])));
        createItemRef(41, "Battle Soul", gfxUI[UI_GFX_POCKET_BATTLE_SOUL], recolourSpriteArray(itemsGfxD[DUNGEON_ITEM_LARGE_SHIELD], DUN_ITEM_PALETTE_DEFAULT, new Array(COLOUR[COLOUR_YELLOW], COLOUR[COLOUR_PINK], COLOUR[COLOUR_RED_DARK], COLOUR[COLOUR_BLACK])));
        createItemRef(42, "Chromatic Plate", gfxUI[UI_GFX_POCKET_CHROMATIC_PLATE], recolourSpriteArray(itemsGfxD[DUNGEON_ITEM_LARGE_SHIELD], DUN_ITEM_PALETTE_DEFAULT, new Array(COLOUR[COLOUR_WHITE], COLOUR[COLOUR_GREEN], COLOUR[COLOUR_GREEN_DARK], COLOUR[COLOUR_BLACK])));

        createItemRef(50, "Adamant Sword", gfxUI[UI_GFX_POCKET_ADAMANT_SWORD], recolourSpriteArray(itemsGfxD[DUNGEON_ITEM_SWORD], DUN_ITEM_PALETTE_DEFAULT, new Array(COLOUR[COLOUR_RED], COLOUR[COLOUR_RED_DARK], COLOUR[COLOUR_GREY_LIGHT], COLOUR[COLOUR_BLACK])));
        createItemRef(51, "Fleshbane", recolourUiGfx(gfxUI[UI_GFX_POCKET_FLESHBANE], COLOUR[COLOUR_GREEN], COLOUR[COLOUR_YELLOW]), recolourSpriteArray(itemsGfxD[DUNGEON_ITEM_SWORD], DUN_ITEM_PALETTE_DEFAULT, new Array(COLOUR[COLOUR_BROWN], COLOUR[COLOUR_RED_DARK], COLOUR[COLOUR_GREY_LIGHT], COLOUR[COLOUR_BLACK])));
        createItemRef(52, "Demon Blade", recolourUiGfx(gfxUI[UI_GFX_POCKET_DEMON_BLADE], COLOUR[COLOUR_GREEN], COLOUR[COLOUR_BLUE]), recolourSpriteArray(itemsGfxD[DUNGEON_ITEM_SWORD], DUN_ITEM_PALETTE_DEFAULT, new Array(COLOUR[COLOUR_BLUE], COLOUR[COLOUR_BLUE_DARK], COLOUR[COLOUR_GREY_LIGHT], COLOUR[COLOUR_BLACK])));
        createItemRef(53, "Rune Sword", gfxUI[UI_GFX_POCKET_RUNE_SWORD], recolourSpriteArray(itemsGfxD[DUNGEON_ITEM_SWORD], DUN_ITEM_PALETTE_DEFAULT, new Array(COLOUR[COLOUR_GREEN], COLOUR[COLOUR_GREEN_DARK], COLOUR[COLOUR_GREY_LIGHT], COLOUR[COLOUR_BLACK])));
        createItemRef(54, "Soul Sucker", gfxUI[UI_GFX_POCKET_SOUL_SUCKER], recolourSpriteArray(itemsGfxD[DUNGEON_ITEM_SWORD], DUN_ITEM_PALETTE_DEFAULT, new Array(COLOUR[COLOUR_PINK], COLOUR[COLOUR_RED], COLOUR[COLOUR_GREY_LIGHT], COLOUR[COLOUR_BLACK])));
        createItemRef(55, "Adamant Axe", gfxUI[UI_GFX_POCKET_ADAMANT_AXE], recolourSpriteArray(itemsGfxD[DUNGEON_ITEM_SWORD], DUN_ITEM_PALETTE_DEFAULT, new Array(COLOUR[COLOUR_YELLOW], COLOUR[COLOUR_PINK], COLOUR[COLOUR_GREY_LIGHT], COLOUR[COLOUR_BLACK])));
        createItemRef(56, "Battle Axe", recolourUiGfx(gfxUI[UI_GFX_POCKET_BATTLE_AXE], COLOUR[COLOUR_GREEN], COLOUR[COLOUR_GREY_LIGHT]), recolourSpriteArray(itemsGfxD[DUNGEON_ITEM_AXE], DUN_ITEM_PALETTE_DEFAULT, new Array(COLOUR[COLOUR_RED_DARK], COLOUR[COLOUR_PINK], COLOUR[COLOUR_GREY_LIGHT], COLOUR[COLOUR_BLACK])));
        createItemRef(57, "Ogre's Axe", recolourUiGfx(gfxUI[UI_GFX_POCKET_OGRES_AXE], COLOUR[COLOUR_GREEN], COLOUR[COLOUR_BLUE]), recolourSpriteArray(itemsGfxD[DUNGEON_ITEM_AXE], DUN_ITEM_PALETTE_DEFAULT, new Array(COLOUR[COLOUR_BLUE], COLOUR[COLOUR_GREEN], COLOUR[COLOUR_GREY_LIGHT], COLOUR[COLOUR_BLACK])));
        createItemRef(58, "Deathbringer", gfxUI[UI_GFX_POCKET_DEATHBRINGER], recolourSpriteArray(itemsGfxD[DUNGEON_ITEM_AXE], DUN_ITEM_PALETTE_DEFAULT, new Array(COLOUR[COLOUR_GREEN], COLOUR[COLOUR_GREEN_DARK], COLOUR[COLOUR_GREY_LIGHT], COLOUR[COLOUR_BLACK])));
        createItemRef(59, "Dragon Axe", gfxUI[UI_GFX_POCKET_DRAGON_AXE], recolourSpriteArray(itemsGfxD[DUNGEON_ITEM_AXE], DUN_ITEM_PALETTE_DEFAULT, new Array(COLOUR[COLOUR_BLUE], COLOUR[COLOUR_BLUE_DARK], COLOUR[COLOUR_GREY_LIGHT], COLOUR[COLOUR_BLACK])));
        createItemRef(60, "Grey Axe", gfxUI[UI_GFX_POCKET_GREY_AXE], recolourSpriteArray(itemsGfxD[DUNGEON_ITEM_AXE], DUN_ITEM_PALETTE_DEFAULT, new Array(COLOUR[COLOUR_GREY_LIGHT], COLOUR[COLOUR_GREY_MEDIUM], COLOUR[COLOUR_GREY_LIGHT], COLOUR[COLOUR_BLACK])));
    }else{
