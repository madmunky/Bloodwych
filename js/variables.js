...
var UI_GFX_POCKET_EMPTY = 0,
    ...
    UI_GFX_ICON_SPELL_ARMOUR = 60,
    UI_GFX_ICON_SPELL_DEFLECT = 61,
    UI_GFX_ICON_SPELL_WARPOWER = 62,
    UI_GFX_ICON_SPELL_VANISH = 63,
    ...
    UI_GFX_ICON_SPELL_ANTIMAGE = 69,
    UI_GFX_ICON_SPELL_TRUEVIEW = 70,
    ...
    UI_GFX_POCKET_EMPTY_ARMOUR = 90,
    UI_GFX_POCKET_EMPTY_LARGE_SHIELD = 91,
    UI_GFX_POCKET_EMPTY_SMALL_SHIELD = 92,
    ...
    UI_GFX_CHARACTER_NAME_BLUE = 149,
    UI_GFX_CHARACTER_NAME_RED = 150,
    UI_GFX_CHARACTER_BOXES = 151,
    UI_GFX_CHARACTER_SCROLL = 152,
    UI_GFX_SCROLL_WAVE = 153,
    //DATA DISK ITEMS
    UI_GFX_ICON_SPELL_ANCIENT = 154,
    UI_GFX_POCKET_RUNE_SHIELD = 155,
    UI_GFX_POCKET_WAR_SHIELD = 156,
    UI_GFX_POCKET_DEMON_SCALE = 157,
    UI_GFX_POCKET_BATTLE_SOUL = 158,
    UI_GFX_POCKET_CHROMATIC_PLATE = 159,
    UI_GFX_POCKET_ADAMANT_SWORD = 160,
    UI_GFX_POCKET_FLESHBANE = 161,
    UI_GFX_POCKET_DEMON_BLADE = 162,
    UI_GFX_POCKET_RUNE_SWORD = 163,
    UI_GFX_POCKET_SOUL_SUCKER = 164,
    UI_GFX_POCKET_ADAMANT_AXE = 165,
    UI_GFX_POCKET_BATTLE_AXE = 166,
    UI_GFX_POCKET_OGRES_AXE = 167,
    UI_GFX_POCKET_DEATHBRINGER = 168,
    UI_GFX_POCKET_DRAGON_AXE = 169,
    UI_GFX_POCKET_GREY_AXE = 170,
    UI_GFX_ICON_SPELL_PROTECT = 171,
    UI_GFX_ICON_SPELL_ENHANCE = 172;
