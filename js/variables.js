...
var UI_GFX_ID = ['POCKET_EMPTY',
    ...
    'POCKET_SHIELD_6',
    'POCKET_SHIELD_7',
    'POCKET_AMOUR_LEATHER',
    'POCKET_AMOUR_CHAIN',
    'POCKET_AMOUR_PLATE',
    'POCKET_PERMIT',
    'POCKET_HAND_LEFT_AMOUR',
    'POCKET_HAND_RIGHT_AMOUR',
    'POCKET_DAGGER',
    'POCKET_RING_SHINNY',
    'POCKET_SHORT_SWORD',
    'POCKET_GEM_GREENISH',
    ...
    'ICON_SPELL_WARPOWER',
    'ICON_SPELL_VANISH',
    'ICON_SPELL_COMPASS_NORTH',
    'ICON_SPELL_COMPASS_EAST',
    'ICON_SPELL_COMPASS_SOUTH',
    'ICON_SPELL_COMPASS_WEST',
    'ICON_SPELL_LEVITATE',
    'ICON_SPELL_ANTIMAGE',
    'ICON_SPELL_TRUEVIEW',
    'ICON_SPELL_7',
    ...
    'ICON_SPELL_3',
    'ICON_SPELL_4',
    'ICON_SPELL_BOOK_DRAGON_LEFT',
    'ICON_SPELL_BOOK_LEFT',
    'ICON_SPELL_BOOK_RIGHT',
    'ICON_SPELL_BOOK_DRAGON_RIGHT',
    'POCKET_EMPTY_LEFT_HAND',
    'POCKET_EMPTY_RIGHT_HAND',
    'POCKET_EMPTY_ARMOUR',
    'POCKET_EMPTY_LARGE_SHIELD',
    'POCKET_EMPTY_SMALL_SHIELD',
    'ICON_PAUSE',
    'ICON_SAVE',
    'ICON_SLEEP',
    'ICON_BOOKOFSKULLS',
    ...
    'POCKET_DEMON_SCALE',
    'POCKET_BATTLE_SOUL',
    'POCKET_CHROMATIC_PLATE',
    'POCKET_ADAMANT_SWORD',
    'POCKET_FLESHBANE',
    'POCKET_DEMON_BLADE',
    'POCKET_RUNE_SWORD',
    'POCKET_SOUL_SUCKER',
