...
var PALETTE_SERPENT = new Array(COLOUR[COLOUR_GREY_LIGHT], COLOUR[COLOUR_WHITE], COLOUR[COLOUR_GREEN], COLOUR[COLOUR_GREEN_DARK], COLOUR[COLOUR_GREEN], COLOUR[COLOUR_WHITE]),
    ...
    PALETTE_DRAGON = new Array(COLOUR[COLOUR_GREY_LIGHT], COLOUR[COLOUR_YELLOW], COLOUR[COLOUR_PINK], COLOUR[COLOUR_RED], COLOUR[COLOUR_RED], COLOUR[COLOUR_WHITE]),
    PALETTE_CHAOS = new Array(COLOUR[COLOUR_GREY_LIGHT], COLOUR[COLOUR_WHITE], COLOUR[COLOUR_YELLOW], COLOUR[COLOUR_PINK], COLOUR[COLOUR_YELLOW], COLOUR[COLOUR_WHITE]),
    ...
    PALETTE_SERPENT_ARROW = new Array(COLOUR[COLOUR_YELLOW], COLOUR[COLOUR_GREEN], COLOUR[COLOUR_GREEN_DARK], COLOUR[COLOUR_GREY_DARK], COLOUR[COLOUR_YELLOW], COLOUR[COLOUR_GREEN]),
    PALETTE_MOON_ARROW = new Array(COLOUR[COLOUR_WHITE], COLOUR[COLOUR_WHITE], COLOUR[COLOUR_BLUE], COLOUR[COLOUR_BLUE_DARK], COLOUR[COLOUR_BLACK], COLOUR[COLOUR_BLUE_DARK]),
    PALETTE_DRAGON_ARROW = new Array(COLOUR[COLOUR_WHITE], COLOUR[COLOUR_YELLOW], COLOUR[COLOUR_PINK], COLOUR[COLOUR_RED]),
    PALETTE_CHAOS_ARROW = new Array(COLOUR[COLOUR_WHITE], COLOUR[COLOUR_WHITE], COLOUR[COLOUR_YELLOW], COLOUR[COLOUR_PINK], COLOUR[COLOUR_PINK], COLOUR[COLOUR_YELLOW]),
    PALETTE_BRONZE_ARROW = new Array(COLOUR[COLOUR_PINK], COLOUR[COLOUR_BROWN], COLOUR[COLOUR_BROWN], COLOUR[COLOUR_RED_DARK]),
    PALETTE_GREEN_ARROW = new Array(COLOUR[COLOUR_GREEN], COLOUR[COLOUR_GREEN_DARK], COLOUR[COLOUR_GREY_DARK], COLOUR[COLOUR_GREY_DARKEST]),
    PALETTE_GOLD_ARROW = new Array(COLOUR[COLOUR_WHITE], COLOUR[COLOUR_YELLOW], COLOUR[COLOUR_PINK], COLOUR[COLOUR_BROWN], COLOUR[COLOUR_BROWN], COLOUR[COLOUR_YELLOW]),

    PALETTE_SERPENT_BIG = new Array(COLOUR[COLOUR_GREEN_DARK], COLOUR[COLOUR_GREEN], COLOUR[COLOUR_YELLOW], COLOUR[COLOUR_GREY_DARK], COLOUR[COLOUR_GREEN], COLOUR[COLOUR_WHITE]),
    PALETTE_MOON_BIG = new Array(COLOUR[COLOUR_BLUE_DARK], COLOUR[COLOUR_BLUE], COLOUR[COLOUR_GREEN], COLOUR[COLOUR_GREY_DARK], COLOUR[COLOUR_BLUE], COLOUR[COLOUR_WHITE]),
    PALETTE_DRAGON_BIG = new Array(COLOUR[COLOUR_RED], COLOUR[COLOUR_PINK], COLOUR[COLOUR_YELLOW], COLOUR[COLOUR_RED_DARK], COLOUR[COLOUR_RED], COLOUR[COLOUR_WHITE]),
    PALETTE_CHAOS_BIG = new Array(COLOUR[COLOUR_PINK], COLOUR[COLOUR_YELLOW], COLOUR[COLOUR_WHITE], COLOUR[COLOUR_BROWN], COLOUR[COLOUR_YELLOW], COLOUR[COLOUR_WHITE]),
    PALETTE_DISRUPT_BIG = new Array(COLOUR[COLOUR_BLACK], COLOUR[COLOUR_BLACK], COLOUR[COLOUR_BLACK], COLOUR[COLOUR_BLACK], COLOUR[COLOUR_YELLOW], COLOUR[COLOUR_BLACK]),
    PALETTE_BLAZE_BIG = new Array(COLOUR[COLOUR_YELLOW], COLOUR[COLOUR_PINK], COLOUR[COLOUR_RED], COLOUR[COLOUR_RED_DARK], COLOUR[COLOUR_RED], COLOUR[COLOUR_WHITE]),

    PALETTE_PIT_FLASH = new Array(null, null, null, null, COLOUR[COLOUR_GREY_MEDIUM], null),
    PALETTE_TELEPORT_FLASH = new Array(null, null, null, null, COLOUR[COLOUR_WHITE], COLOUR[COLOUR_BLACK]);
