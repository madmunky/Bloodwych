...
function initItemRefs() {
	createItemRef(0, "Empty Item", gfxUI[UI_GFX_POCKET_EMPTY], null);
        ...
        createItemRef(35, "Crystal Plate", recolourUiGfx(gfxUI[UI_GFX_POCKET_AMOUR_PLATE],COLOUR[COLOUR_GREEN],COLOUR[COLOUR_PINK]), recolourSpriteArray(dungeonItems[DUNGEON_ITEM_AMOUR],DUN_ITEM_PALETTE_DEFAULT,new Array(COLOUR[COLOUR_WHITE],COLOUR[COLOUR_PINK],COLOUR[COLOUR_RED_DARK],COLOUR[COLOUR_BLACK])));
        ...
        createItemRef(47, "Crystal Gloves", recolourUiGfx(gfxUI[UI_GFX_POCKET_GLOVE],COLOUR[COLOUR_GREEN],COLOUR[COLOUR_PINK]), recolourSpriteArray(dungeonItems[DUNGEON_ITEM_GLOVE],DUN_ITEM_PALETTE_DEFAULT,new Array(COLOUR[COLOUR_WHITE],COLOUR[COLOUR_PINK],COLOUR[COLOUR_RED_DARK],COLOUR[COLOUR_BLACK])));
        createItemRef(48, "Dagger", gfxUI[UI_GFX_POCKET_DAGGER], recolourSpriteArray(dungeonItems[DUNGEON_ITEM_DAGGER],DUN_ITEM_PALETTE_DEFAULT,new Array(COLOUR[COLOUR_WHITE],COLOUR[COLOUR_PINK],COLOUR[COLOUR_RED_DARK],COLOUR[COLOUR_BLACK])));
        createItemRef(49, "Stealth Blade", gfxUI[UI_GFX_POCKET_SHORT_SWORD], recolourSpriteArray(dungeonItems[DUNGEON_ITEM_DAGGER],DUN_ITEM_PALETTE_DEFAULT,new Array(COLOUR[COLOUR_WHITE],COLOUR[COLOUR_PINK],COLOUR[COLOUR_RED_DARK],COLOUR[COLOUR_BLACK])));
        createItemRef(50, "Short Sword", gfxUI[UI_GFX_POCKET_SWORD_1], recolourSpriteArray(dungeonItems[DUNGEON_ITEM_SWORD],DUN_ITEM_PALETTE_DEFAULT,new Array(COLOUR[COLOUR_WHITE],COLOUR[COLOUR_PINK],COLOUR[COLOUR_RED_DARK],COLOUR[COLOUR_BLACK])));
        createItemRef(51, "Long Sword", recolourUiGfx(gfxUI[UI_GFX_POCKET_SWORD_2],COLOUR[COLOUR_GREEN],COLOUR[COLOUR_YELLOW]), recolourSpriteArray(dungeonItems[DUNGEON_ITEM_SWORD],DUN_ITEM_PALETTE_DEFAULT,new Array(COLOUR[COLOUR_WHITE],COLOUR[COLOUR_PINK],COLOUR[COLOUR_RED_DARK],COLOUR[COLOUR_BLACK])));
        createItemRef(52, "Mithril Sword", recolourUiGfx(gfxUI[UI_GFX_POCKET_SWORD_2],COLOUR[COLOUR_GREEN],COLOUR[COLOUR_BLUE]), recolourSpriteArray(dungeonItems[DUNGEON_ITEM_SWORD],DUN_ITEM_PALETTE_DEFAULT,new Array(COLOUR[COLOUR_WHITE],COLOUR[COLOUR_PINK],COLOUR[COLOUR_RED_DARK],COLOUR[COLOUR_BLACK])));
        createItemRef(53, "Fleshbane", gfxUI[UI_GFX_POCKET_SWORD_3], recolourSpriteArray(dungeonItems[DUNGEON_ITEM_SWORD],DUN_ITEM_PALETTE_DEFAULT,new Array(COLOUR[COLOUR_WHITE],COLOUR[COLOUR_PINK],COLOUR[COLOUR_RED_DARK],COLOUR[COLOUR_BLACK])));
        createItemRef(54, "Demon Blade", gfxUI[UI_GFX_POCKET_SWORD_4], recolourSpriteArray(dungeonItems[DUNGEON_ITEM_SWORD],DUN_ITEM_PALETTE_DEFAULT,new Array(COLOUR[COLOUR_WHITE],COLOUR[COLOUR_PINK],COLOUR[COLOUR_RED_DARK],COLOUR[COLOUR_BLACK])));
        createItemRef(55, "Ace of Swords", gfxUI[UI_GFX_POCKET_SWORD_5], recolourSpriteArray(dungeonItems[DUNGEON_ITEM_SWORD],DUN_ITEM_PALETTE_DEFAULT,new Array(COLOUR[COLOUR_WHITE],COLOUR[COLOUR_PINK],COLOUR[COLOUR_RED_DARK],COLOUR[COLOUR_BLACK])));
