...
var PALETTE_SERPENT = new Array(COLOUR[COLOUR_GREY_LIGHT], COLOUR[COLOUR_WHITE], COLOUR[COLOUR_GREEN], COLOUR[COLOUR_GREEN_DARK]),
	...
	PALETTE_SERPENT_ARROW = new Array(COLOUR[COLOUR_WHITE], COLOUR[COLOUR_WHITE], COLOUR[COLOUR_GREEN], COLOUR[COLOUR_GREEN_DARK]),
	PALETTE_CHAOS_ARROW = new Array(COLOUR[COLOUR_WHITE], COLOUR[COLOUR_WHITE], COLOUR[COLOUR_YELLOW], COLOUR[COLOUR_PINK]),
	PALETTE_DRAGON_ARROW = new Array(COLOUR[COLOUR_WHITE], COLOUR[COLOUR_YELLOW], COLOUR[COLOUR_PINK], COLOUR[COLOUR_RED]),
	PALETTE_MOON_ARROW = new Array(COLOUR[COLOUR_WHITE], COLOUR[COLOUR_WHITE], COLOUR[COLOUR_BLUE], COLOUR[COLOUR_BLUE_DARK]),
	...
	PALETTE_DISRUPT_BIG = new Array(COLOUR[COLOUR_BLACK], COLOUR[COLOUR_BLACK], COLOUR[COLOUR_BLACK], COLOUR[COLOUR_BLACK]),
	PALETTE_BLAZE_BIG = new Array(COLOUR[COLOUR_YELLOW], COLOUR[COLOUR_PINK], COLOUR[COLOUR_RED], COLOUR[COLOUR_RED_DARK]);
...
var TEXT_DOOR_LOCKED = "THE DOOR IS LOCKED",
	...
	TEXT_ART_DEAD = "ART DEAD",
        TEXT_READY = "THOU ART NOW READY TO BEGIN THY QUEST",
...
var COMMUNICATION_RECRUIT = 0,
	...
	TEXT_COMMUNICATION = [
		...
		["GREETINGS", null, null, 3],
		["WHY DOST BURDEN ME WITH THY COMPANY?"],
		["WHO ART THOU?"],
		["WHAT BE THY BUSINESS?"],

		["COME JOIN MY MERRY BAND", COMMUNICATION_PAGE_COMMUNICATE_0, COMMUNICATION_RECRUIT, 4],
		...
		["WHO ART THOU?", COMMUNICATION_PAGE_IDENTIFY, COMMUNICATION_WHO_GOES, 3],
		["MY NAME IS ", COMMUNICATION_PAGE_IDENTIFY, COMMUNICATION_NAME_SELF, 3, true, 'name'],
		["MY NAME IS NOT IMPORTANT"],
		["I AM ZENDIK THE MASTER OF CREATION"],

		["WHAT BE THY BUSINESS?", COMMUNICATION_PAGE_IDENTIFY, COMMUNICATION_THY_TRADE, 2],
		["NONE OF THY BUSINESS I'M SURE"],
		["I AM A NOBLE ", COMMUNICATION_PAGE_IDENTIFY, COMMUNICATION_REVEAL_SELF, 1, true, 'prof'],

		["WHERE IS THIS OF WHICH THOU HAST SPOKEN?", COMMUNICATION_PAGE_COMMUNICATE_0, COMMUNICATION_WHEREABOUTS, 1],
		["LOOK TO THE TOWERS MY FRIEND"],

		["HAST HEARD OF ANY POWERFUL BEINGS?", COMMUNICATION_PAGE_INQUIRY, COMMUNICATION_PERSONS, 1],
		["NEWS IS SCARCE IN THESE PARTS"],

		["KNOWEST THOU OF ANY WEAPONS OF NOTE?", COMMUNICATION_PAGE_INQUIRY, COMMUNICATION_OBJECTS, 1],
		["WHO CAN SAY WHAT IS OF NOTE?"],

		["KNOWEST THOU OF ANY ENCHANTED ITEMS?", COMMUNICATION_PAGE_INQUIRY, COMMUNICATION_MAGIC_ITEMS, 1],
		["I HEAR CRYSTALS ARE WORTH SEEKING"],

		["HAST THOU HEARD ANY LEGENDS?", COMMUNICATION_PAGE_INQUIRY, COMMUNICATION_FOLK_LORE, 1],
		["I HEAR ZENDIK IS NOT WHOLLY A WORM"],

		["I AM THY WORST NIGHTMARE", COMMUNICATION_PAGE_COMMUNICATE_1, COMMUNICATION_THREAT, 2],
		["PICK ON SOMEONE THY OWN SIZE THOU SLUG"],
		["GIVE ME A BREAK"],

		["WILT THOU ACCEPT SOME SMALL TOKEN?", COMMUNICATION_PAGE_COMMUNICATE_1, COMMUNICATION_BRIBE, 4],
		["WOULDST THOU RIP ME OFF"],
		["METHINKS THOU ART TOO GREEDY"],
		["I NEVER TRUST THE UNNATURAL"],
		["MAKE ME THY OFFER"],

		["YES", COMMUNICATION_PAGE_COMMUNICATE_1, COMMUNICATION_YES, 3],
		["THAT'S VERY POSSIBLE"],
		["I CANNOT BUT AGREE"],
		["THAT SEEMS VERY LIKELY"],

		["NO", COMMUNICATION_PAGE_COMMUNICATE_1, COMMUNICATION_NO, 3],
		["INDEED NOT"],
		["I'M NOT ABOUT TO ARGUE WITH THEE"],
		["MAYBE TRUE BUT THOU SHOULD BE SO LUCKY"],

		["*** OFFER FOR ", COMMUNICATION_PAGE_TRADING, COMMUNICATION_OFFER, 4, null, 'item'], //TEST THIS ONE!!
		["THY COINAGE IS WORTHLESS TO ME"],
		["I DO NOT TRADE IN TRINKETS"],
		["I NEED NOT THY TRASH"],
		["I TRUST THIS PLEASES THEE"],

		["*** PURCHASE", COMMUNICATION_PAGE_TRADING, COMMUNICATION_PURCHASE], //TEST THIS ONE!!
		["THY COINAGE IS WORTHLESS TO ME"],
		["I DO NOT TRADE IN TRINKETS"],
		["I NEED NOT THY TRASH"],
		["I TRUST THIS PLEASES THEE"],

		["*** EXCHANGE", COMMUNICATION_PAGE_TRADING, COMMUNICATION_EXCHANGE], //TEST THIS ONE!!
		["THY COINAGE IS WORTHLESS TO ME"],
		["I DO NOT TRADE IN TRINKETS"],
		["I NEED NOT THY TRASH"],
		["I TRUST THIS PLEASES THEE"],

		["*** SELL", COMMUNICATION_PAGE_TRADING, COMMUNICATION_SELL, null, 'item'], //TEST THIS ONE!!
		["THY COINAGE IS WORTHLESS TO ME"],
		["I DO NOT TRADE IN TRINKETS"],
		["I NEED NOT THY TRASH"],
		["I TRUST THIS PLEASES THEE"]
