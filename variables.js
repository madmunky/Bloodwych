...
var TEXT_DOOR_LOCKED = "THE DOOR IS LOCKED",
	...
	TEXT_VI = "VI",
	TEXT_SP_PTS = "SP.PTS",
	TEXT_COMMUNICATE = "COMMUNICATE",
	TEXT_COMMEND = "COMMEND",
	TEXT_VIEW = "VIEW",
	TEXT_WAIT = "WAIT",
	...
	TEXT_ASLEEP = "ASLEEP",
        TEXT_SPELL_0_NAME = "ARMOUR",
        TEXT_SPELL_1_NAME = "TERROR",
        TEXT_SPELL_2_NAME = "VITALISE",
        TEXT_SPELL_3_NAME = "BEGUILE",
        TEXT_SPELL_4_NAME = "DEFLECT",
        TEXT_SPELL_5_NAME = "MAGELOCK",
        TEXT_SPELL_6_NAME = "CONCEAL",
        TEXT_SPELL_7_NAME = "WARPOWER",
        TEXT_SPELL_8_NAME = "MISSILE",
        TEXT_SPELL_9_NAME = "VANISH",
        TEXT_SPELL_10_NAME = "PARALYZE",
        TEXT_SPELL_11_NAME = "ALCHEMY",
        TEXT_SPELL_12_NAME = "CONFUSE",
        TEXT_SPELL_13_NAME = "LEVITATE",
        TEXT_SPELL_14_NAME = "ANTIMAGE",
        TEXT_SPELL_15_NAME = "RECHARGE",
        TEXT_SPELL_16_NAME = "TRUEVIEW",
        TEXT_SPELL_17_NAME = "RENEW",
        TEXT_SPELL_18_NAME = "VIVIFY",
        TEXT_SPELL_19_NAME = "DISPELL",
        TEXT_SPELL_20_NAME = "FIREPATH",
        TEXT_SPELL_21_NAME = "ILLUSION",
        TEXT_SPELL_22_NAME = "COMPASS",
        TEXT_SPELL_23_NAME = "SPELLTAP",
        TEXT_SPELL_24_NAME = "DISRUPT",
        TEXT_SPELL_25_NAME = "FIREBALL",
        TEXT_SPELL_26_NAME = "WYCHWIND",
        TEXT_SPELL_27_NAME = "ARC BOLT",
        TEXT_SPELL_28_NAME = "FORMWALL",
        TEXT_SPELL_29_NAME = "SUMMON",
        TEXT_SPELL_30_NAME = "BLAZE",
        TEXT_SPELL_31_NAME = "MINDROCK",
        TEXT_SPELL_0_DESCRIPTION = "WEAR THIS SPELL WITH PRIDE",
        TEXT_SPELL_1_DESCRIPTION = "BOO!",
        TEXT_SPELL_2_DESCRIPTION = "YOU'LL NEVER FEEL SO GOOD",
        TEXT_SPELL_3_DESCRIPTION = "COAT THY TONGUE WITH SILVER!",
        TEXT_SPELL_4_DESCRIPTION = "A SPELL A DAY KEEPS AN ARROW AWAY",
        TEXT_SPELL_5_DESCRIPTION = "WHY BOTHER WITH ALL THOSE SILLY KEYS?",
        TEXT_SPELL_6_DESCRIPTION = "WHAT CANNOT BE SEEN CANNOT BE STOLEN",
        TEXT_SPELL_7_DESCRIPTION = "YOU TOO CAN HAVE THE STRENGTH OF TEN",
        TEXT_SPELL_8_DESCRIPTION = "ONE IN THE EYE FOR ARCHERS",
        TEXT_SPELL_9_DESCRIPTION = "NOW YOU SEE ME...NOW YOU DON'T",
        TEXT_SPELL_10_DESCRIPTION = "A FROZEN LIFE MAY WELL BE A SHORT ONE",
        TEXT_SPELL_11_DESCRIPTION = "THE HAND OF MIDAS",
        TEXT_SPELL_12_DESCRIPTION = "THEY WON'T KNOW WHAT HIT THEM",
        TEXT_SPELL_13_DESCRIPTION = "A GENUINELY LIGHT SPELL",
        TEXT_SPELL_14_DESCRIPTION = "NEVERMORE WORRY ABOUT SPELLCASTERS",
        TEXT_SPELL_15_DESCRIPTION = "BOOSTS THE FLATTEST OF RINGS!",
        TEXT_SPELL_16_DESCRIPTION = "NEVER AGAIN LOSE AT HIDE AND SEEK",
        TEXT_SPELL_17_DESCRIPTION = "CURES EVERYTHING EXCEPT CRAMP",
        TEXT_SPELL_18_DESCRIPTION = "MAKES DEATH BUT A MINOR INCONVENIENCE",
        TEXT_SPELL_19_DESCRIPTION = "WHAT MAGIC MAKES, MAGIC CAN DESTROY",
        TEXT_SPELL_20_DESCRIPTION = "LAY DOWN THE RED CARPET",
        TEXT_SPELL_21_DESCRIPTION = "REAL ENOUGH TO HURT!",
        TEXT_SPELL_22_DESCRIPTION = "NEVER GET LOST AGAIN",
        TEXT_SPELL_23_DESCRIPTION = "THE BANE OF ALL MAGIC USERS",
        TEXT_SPELL_24_DESCRIPTION = "KNOWN TO SOME AS DEATHSTRIKE",
        TEXT_SPELL_25_DESCRIPTION = "A BLAST AT PARTIES",
        TEXT_SPELL_26_DESCRIPTION = "JUST BLOW THEM AWAY",
        TEXT_SPELL_27_DESCRIPTION = "AN ELECTRIFYING EXPERIENCE",
        TEXT_SPELL_28_DESCRIPTION = "FOR THOSE WHO LOVE WALLS",
        TEXT_SPELL_29_DESCRIPTION = "YOU'LL NEVER WALK ALONE",
        TEXT_SPELL_30_DESCRIPTION = "NONE SHALL PASS THIS FIERY BLAST",
        TEXT_SPELL_31_DESCRIPTION = "FOR THOSE WHO THINK THEY LOVE WALLS";
...
var DUNGEON_ITEM_POTION = 0,
	...
	DUNGEON_ITEM_APPLE_HALF = 26,
        DUNGEON_ITEM_EXPLOSION_SMALL = 27,
        DUNGEON_ITEM_EXPLOSION_BIG = 28,
        DUNGEON_ITEM_EXPLOSION_ARROW = 29;
