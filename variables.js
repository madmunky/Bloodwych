...
var TEXT_DOOR_LOCKED = "THE DOOR IS LOCKED",
	...
	TEXT_ASLEEP = "ASLEEP",
        ...
        TEXT_SPELL_0_DECRIPTION = "WEAR THIS SPELL WITH PRIDE",
        TEXT_SPELL_1_DECRIPTION = "BOO!",
        TEXT_SPELL_2_DECRIPTION = "YOU'LL NEVER FEEL SO GOOD",
        TEXT_SPELL_3_DECRIPTION = "COAT THY TONGUE WITH SILVER!",
        TEXT_SPELL_4_DECRIPTION = "A SPELL A DAY KEEPS AN ARROW AWAY",
        TEXT_SPELL_5_DECRIPTION = "WHY BOTHER WITH ALL THOSE SILLY KEYS?",
        TEXT_SPELL_6_DECRIPTION = "WHAT CANNOT BE SEEN CANNOT BE STOLEN",
        TEXT_SPELL_7_DECRIPTION = "YOU TOO CAN HAVE THE STRENGTH OF TEN",
        TEXT_SPELL_8_DECRIPTION = "ONE IN THE EYE FOR ARCHERS",
        TEXT_SPELL_9_DECRIPTION = "NOW YOU SEE ME...NOW YOU DON'T",
        TEXT_SPELL_10_DECRIPTION = "A FROZEN LIFE MAY WELL BE A SHORT ONE",
        TEXT_SPELL_11_DECRIPTION = "THE HAND OF MIDAS",
        TEXT_SPELL_12_DECRIPTION = "THEY WON'T KNOW WHAT HIT THEM",
        TEXT_SPELL_13_DECRIPTION = "A GENUINELY LIGHT SPELL",
        TEXT_SPELL_14_DECRIPTION = "NEVERMORE WORRY ABOUT SPELLCASTERS",
        TEXT_SPELL_15_DECRIPTION = "BOOSTS THE FLATTEST OF RINGS!",
        TEXT_SPELL_16_DECRIPTION = "NEVER AGAIN LOSE AT HIDE AND SEEK",
        TEXT_SPELL_17_DECRIPTION = "CURES EVERYTHING EXCEPT CRAMP",
        TEXT_SPELL_18_DECRIPTION = "MAKES DEATH BUT A MINOR INCONVENIENCE",
        TEXT_SPELL_19_DECRIPTION = "WHAT MAGIC MAKES, MAGIC CAN DESTROY",
        TEXT_SPELL_20_DECRIPTION = "LAY DOWN THE RED CARPET",
        TEXT_SPELL_21_DECRIPTION = "REAL ENOUGH TO HURT!",
        TEXT_SPELL_22_DECRIPTION = "NEVER GET LOST AGAIN",
        TEXT_SPELL_23_DECRIPTION = "THE BANE OF ALL MAGIC USERS",
        TEXT_SPELL_24_DECRIPTION = "KNOWN TO SOME AS DEATHSTRIKE",
        TEXT_SPELL_25_DECRIPTION = "A BLAST AT PARTIES",
        TEXT_SPELL_26_DECRIPTION = "JUST BLOW THEM AWAY",
        TEXT_SPELL_27_DECRIPTION = "AN ELECTRIFYING EXPERIENCE",
        TEXT_SPELL_28_DECRIPTION = "FOR THOSE WHO LOVE WALLS",
        TEXT_SPELL_29_DECRIPTION = "YOU'LL NEVER WALK ALONE",
        TEXT_SPELL_30_DECRIPTION = "NONE SHALL PASS THIS FIERY BLAST",
        TEXT_SPELL_31_DECRIPTION = "FOR THOSE WHO THINK THEY LOVE WALLS";
