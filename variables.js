...
var TEXT_DOOR_LOCKED = "THE DOOR IS LOCKED",
	...
	TEXT_SPELL_DESCRIPTION = [
        ...
        SCROLL_TEXT = [
                "THE KEY ABOVE DOTH LIE BELOW",
                "THE KEY OF HUE IS WHAT I'M DUE",
                "MY KEY I BESTOW TO THOSE WHO CAN SOLVE THIS MAZE",
                "A SWORD A BOW THIS WALL MUST GO",
                "REFORGE THY BONES",
                "WELCOME BACK",
                "BRING THE CRYSTALS, FIND THEM ALL, ONLY THEN WILL EVIL FALL",
                "BEYOND LIES THE KEEP",
                "POTIONS ALE 8 SLIME 10 ELIXIR 12 BROTH 15",
                "ALL MORTALS BEWARE!",
                "HERE LIES THE CRYPT",
                "EYE OF A NEWT, WING OF A BAT, TOE OF A SLOTH, OR SOMETHING LIKE THAT",
                "THE SERPENT TOWER",
                "ZENDIK WILL NOT SUFFER ANY TO TRESPASS",
                "THE CHAOS TOWER",
                "THE TOWER OF THE DRAGON",
                "THE TOWER OF THE MOON",
                "THE MENAGERIE APPROACH WITH CARE",
                "FAST ROUTE DOWN!",
                "DAGGER 5 LSHIELD 6 SWORDS 10 STAVES 8 LEATHER 7 CHAIN 12 SHIELD 10 ARMOURY GLOVES 10 AXE 12 SHIELD 15 PLATE 16",
                "GREETINGS TO THEE FOOLISH INTRUDERS",
                "LOOK BEHIND YOU!",
                "THE PRIZE YOU SEEK IS FAR ABOVE",
                "ALL BELIEVERS ARE WELCOME",
                "PLACE THE GEM IN THE HOLE TO REACH YOUR GOAL",
                "YOU CAN REACH THE PRIZE BUT WILL YOU ESCAPE?",
                "FARE THEE WELL MY FRIENDS",
                "THE GEM IN THE KEEP WILL SHOW YOU THE MOON",
                "THOSE WHO SEEK THE EYE SHALL PERISH",
                "THE CRYSTALS CAGE THE POWER",
                "ASCEND TO THE EYE OF THE SERPENT",
                "NOW YOU ARE IN TROUBLE",
                "PARTING IS SUCH SWEET SORROW",
                "WE SELL THE BEST THAT MONEY CAN BUY FOR THE",
                "FIRST  YOU RISE FOR THE SECOND BE WISE",
                "THE RINGS WERE MADE FROM THE SHARDS OF PUREST CRYSTALS",
                "BEWARE THE PSYCHIC BARRIERS",
                "RUN THE GAUNTLET!",
                "THE GREAT BEAST DID COME FROM THE OTHER WORLD",
                "LOOK HARD AND THOU SHALT SEE",
                "TO PASS THE LOCK JUST TURN THE BLOCK",
                "ONWARDS TO THY GREATER GLORIES THE OLD",
                "ONES WARD THE LAIR OF THE DRAGON'S HEART",
                "YOU WILL NEVER DEFEAT ZENDIK IN HIS LAIR GOING",
                "FURTHER WILL ENSURE YOUR DEATHS",
                "WITHIN THE DRAGON LIES THE POWER",
                "NORTHWARD YOU MUST TRAVEL TO CAGE THE ARC",
                "THE DRAGON HEART AWAKES",
                "THE LORDS OF CHAOS AWAIT YOU",
                "CHAOS CAN NOT BE RULED BY MAN",
                "THE GREAT BLADE",
                "YOU MUST RISE BEFORE YOU FALL",
                "ONLY THEY WITH THE QUICKEST HAND AND KEENEST EYE WILL PREVAIL",
                "BE BRAVE AND PRESS ONWARDS",
                "YOU HAVE DONE WELL NOW THE CHALLENGE 	BEGINS",
                "ZENDIK HAS LOST CONTROL",
                "PREPARE TO DIE ACCURSED DEFILERS",
                "POTIONS ALE 8 SLIME 10 ELIXIR 12 BROTH 15",
                "ZENDIK BIDS THEE ENTER",
                "NONE SHALL PASS",
                "THE MASTER IS NOW THE SLAVE",
                "THE ACE HAS NO POWER WITHOUT THE CHAOS GLOVES",
                "THE DARK ONE HAS ESCAPED HIS BONDS AND NOW RAVAGES THE LAND",
                "HEREIN DWELLS THE LORD ZENDIK",
                "YOU MUST PLACE THE CRYSTALS EACH IN SEQUENCE",
                "USING THE MOON WILL OPEN THE TOMB",
                "DRAGON TO CHAOS AND THEN THE LAST",
                "WITH SERPENT RAGE ENTER THE CAGE",
                "GODS MAY KILL AND MORTALS MAY FEAR THE",
                "CRYSTAL OF CHAOS SHALL SUMMON IT NEAR",
                "BEWARE THE LEGION OF THE UNDEAD",
                "THY QUEST HAS COME TO AN END -- BLOODWYCH IS RESTORED"
            ];
